...
FROM dcanumn/external-software:R2019a-test
...
RUN git clone -b R2019a-test --single-branch --depth 1 https://github.com/DCAN-Labs/dcan_bold_processing.git dcan_bold_proc
