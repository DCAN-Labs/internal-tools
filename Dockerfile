...
FROM dcanumn/external-software:R2023b-test
...
RUN git clone -b R2023b-test --single-branch --depth 1 https://github.com/DCAN-Labs/dcan_bold_processing.git dcan_bold_proc
